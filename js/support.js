(function(){
  ...
  /* 交互结构沿用《松涛粮站》的 1 元自愿支持逻辑：三重本地标记、二维码、已完成/稍后、感谢提示。
     《栖山公寓》只调整触发时机、文案和视觉，不把支持状态接入任何谜题或结局。 */
  ...
  const MIN_ELAPSED=150000;   // 至少浏览约 2.5 分钟
  const FALLBACK=300000;      // 最迟约 5 分钟出现一次
  ...
  const Support={
    ...
    create(){
      const html=`<div class="qs-support-overlay" id="qs-support-overlay" role="dialog" aria-modal="true" aria-labelledby="qs-support-title" aria-describedby="qs-support-desc" style="display:none">
        <div class="qs-support-card"><button class="qs-support-close" type="button" aria-label="关闭支持窗口">×</button><div class="qs-support-inner">
          <div class="qs-support-head"><div class="qs-support-title" id="qs-support-title"><span class="qs-support-heart">♡</span><span>支持《栖山公寓》</span><span class="qs-support-heart">♡</span></div><div class="qs-support-sub">1元 自愿打赏 · 不影响任何游戏内容</div></div>
          ...
          <div class="qs-support-message" id="qs-support-desc"><p class="warm">你好，我是 abc studio 的独立开发者。</p><p>《栖山公寓》里看似普通的房源、旧照片、工单与图纸，都需要反复核对时间、编号和细节。<br>如果这次调查让你愿意多停留一会儿，一元支持会成为继续做下一部作品的动力。</p><p class="small-note">支持不会改变结局，也不会解锁任何页面、证据或提示。</p><p><a href="${QR}" target="_blank" rel="noopener">收款码未显示？打开备用图片</a></p></div></div>
    ...
    planAuto(){
      ...
      // 相当于《松涛粮站》“完成第一次有效修复后弹一次”：这里不设章节锁，因此采用真实浏览进度 + 时间。
